...
SELECT MOVIE.TITLE AS title, MOVIEEXEC.NAME AS name 
FROM MOVIE 
...
SELECT DISTINCT MOVIEEXEC.NAME AS name
FROM MOVIEEXEC JOIN MOVIE 
ON MOVIEEXEC.CERT# = MOVIE.PRODUCERC#
WHERE TITLE IN 
	(SELECT MOVIETITLE FROM STARSIN WHERE STARNAME = 'Harrison Ford');


--3)

SELECT DISTINCT MOVIE.STUDIONAME AS name, STARSIN.STARNAME AS starname
FROM STARSIN 
...
SELECT STARSIN.STARNAME AS starname, MOVIEEXEC.NETWORTH AS networth, STARSIN.MOVIETITLE AS title
FROM MOVIE 
...
SELECT MOVIESTAR.NAME AS name, STARSIN.MOVIETITLE AS movietitle
FROM MOVIESTAR 
...
SELECT STARSIN.STARNAME AS starname
FROM STARSIN 
JOIN MOVIE ON STARSIN.MOVIETITLE = MOVIE.TITLE
