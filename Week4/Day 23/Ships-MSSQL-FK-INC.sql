...
SELECT COUNT (TYPE) as No_BattleShips
FROM CLASSES 
WHERE TYPE = 'bb';
...
SELECT SHIPS.CLASS as class, COUNT(OUTCOMES.RESULT) as No_Sunk
...
SELECT COUNTRY, CONVERT(numeric(10,2),AVG(BORE)) as avg_bore
FROM CLASSES
GROUP BY COUNTRY;
...
CREATE NONCLUSTERED INDEX IX_BATTLES_DATE
ON BATTLES ([DATE]);

CREATE NONCLUSTERED INDEX IX_CLASSES_TYPE
ON CLASSES ([TYPE]);

CREATE NONCLUSTERED INDEX IX_CLASSES_COUNTRY
ON CLASSES ([COUNTRY]);

CREATE NONCLUSTERED INDEX IX_CLASSES_NUMGUNS
ON CLASSES ([NUMGUNS]);

CREATE NONCLUSTERED INDEX IX_OUTCOMES_RESULT
ON OUTCOMES ([RESULT]);

CREATE NONCLUSTERED INDEX IX_SHIPS_LAUNCHED
ON SHIPS ([LAUNCHED]);

CREATE NONCLUSTERED INDEX IX_SHIPS_CLASS
ON SHIPS ([CLASS]);


-- removing the indexes:

DROP INDEX IX_BATTLES_DATE
ON BATTLES;

DROP INDEX IX_CLASSES_TYPE
ON CLASSES;

DROP INDEX IX_CLASSES_COUNTRY
ON CLASSES;

DROP INDEX IX_CLASSES_NUMGUNS
ON CLASSES;

DROP INDEX IX_OUTCOMES_RESULT
ON OUTCOMES;

DROP INDEX IX_SHIPS_LAUNCHED
ON SHIPS;

DROP INDEX IX_SHIPS_CLASS
ON SHIPS;